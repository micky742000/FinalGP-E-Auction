...
class ProductDetailsPage extends StatefulWidget {
  ...
  const ProductDetailsPage({Key key, @required this.id, this.boxFit})
      : super(key: key);
                ...
                child: Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      image: ListProvider(context)[widget.id].mainPic,
                      fit: widget.boxFit,
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text(
                          ListProvider(context)[widget.id].name,
                          style: const TextStyle(fontSize: 24),
                        ),
                        Text(
                          ListProvider(context)[widget.id].location,
                        ...
                        Text(
                          ListProvider(context)[widget.id].description,
                          style: Theme.of(context)
                              .textTheme
                              .bodyText1
                              .apply(color: Colors.grey),
                        ...
                        Text(
                          "Highest Bid: ${ListProvider(context)[widget.id].minBid} EGP",
                          style: Theme.of(context).textTheme.subtitle1,
                        ),
                        const SizedBox(),
                        Row(
                          children: [
                            ...
                            CountDownText(
                              due: DateTime.parse(
                                  ListProvider(context)[widget.id].endDate),
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount:
                                ListProvider(context)[widget.id].photos.length,
                            itemBuilder: (ctx, i) {
                              return Padding(
                                padding:
                                ...
                                child: ClipRRect(
                                  ...
                                  child: FadeInImage.assetNetwork(
                                    placeholder: widget.assetPath,
                                    image: ListProvider(context)[widget.id]
                                        .photos[i],
                                    fit: widget.boxFit,
                                    alignment: Alignment.topCenter,
                                    fadeInDuration:
                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (value) {
                              if (int.parse(value) >
                                  ListProvider(context)[widget.id].minBid) {
                        ...
                        DateTime.now().compareTo(DateTime.parse(
                                  ...
                                  press: () async{
                                    ...
                                    setState(() {
                                      if (_formKey.currentState.validate()) {
                                        if (coins >=
                                            0.25 *
                                                ListProvider(context)[widget.id]
                                                    .minBid) {
                                         if (coins <
                                            0.25 *
                                                (ListProvider(context)[widget.id]
                                          ...
                                          if(ListProvider(context)[widget.id]
                                              .userwinner == userwinnername ){
                            ...
                            : Text(
                                "Bid Is Endded The Winner is ${ListProvider(context)[widget.id].userwinner[0]}",
                                style: Theme.of(context).textTheme.subtitle1,
                              ),
                      ],
                    ),
